<template>
  <div class="p-8 space-y-8">
    ...
    <div class="grid grid-cols-3 gap-4">
      <div
        class="rounded-xl bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 p-5"
      >
        <p class="text-xs uppercase tracking-wide text-slate-500 dark:text-slate-400">
          Presupuesto Total Q4 2025
        </p>
      ...
      <table class="w-full text-sm">
        ...
        <tbody>
          ...
          >
            ...
            <td class="px-6 py-4">
              <span class="text-blue-600 dark:text-blue-400 font-medium">{{ b.quarter }}</span>
            </td>
...
const budgets = [
  {
    id: '1',
    dependency: 'Secretaría de Finanzas',
    year: 2025,
    quarter: 'Q4 (Oct-Dec)',
    amount: 3000000,
  },
  ...
  {
    id: '5',
    dependency: 'Infraestructura y Obras',
    year: 2025,
    quarter: 'Q4 (Oct-Dec)',
    amount: 6300000,
  },
