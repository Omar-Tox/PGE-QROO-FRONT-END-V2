<template>
  <div v-if="open" class="fixed inset-0 z-50">
    ...
    <div class="absolute inset-0 grid place-items-center p-4">
      <div
        class="w-full max-w-md rounded-2xl bg-white dark:bg-slate-800 shadow-soft border border-slate-200 dark:border-slate-700"
      >
        <div
        ...
        >
          <div>
            <h2 class="text-xl font-semibold text-slate-900 dark:text-slate-100">
              Acceso para servidores públicos
            </h2>
        ...
        <div class="p-6">
          <form class="mt-6 space-y-4" @submit.prevent="onSubmit">
            ...
            <button
              ...
              class="w-full inline-flex items-center justify-center gap-2 rounded-lg bg-primary-600 px-4 py-2.5 text-white font-medium hover:bg-primary-700 disabled:opacity-60"
            >
