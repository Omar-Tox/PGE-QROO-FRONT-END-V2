<template>
  <div class="flex h-screen bg-slate-50 dark:bg-slate-950">
    <aside class="w-64 bg-white dark:bg-slate-900 border-r border-slate-200 dark:border-slate-700 flex flex-col">
      <div class="p-4 border-b border-slate-200 dark:border-slate-700">
        <div class="flex items-center gap-3">
          ...
          <div>
            <p class="font-semibold text-slate-900 dark:text-slate-100 leading-tight text-sm">PGE-QROO</p>
      ...
      <div class="p-4 border-t border-slate-200 dark:border-slate-700 space-y-2">
        ...
        <button @click="$emit('logout')" class="w-full flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm font-medium text-slate-600 dark:text-slate-400 hover:bg-slate-50 dark:hover:bg-slate-800 transition-colors">
    ...
    <div class="flex-1 flex flex-col overflow-hidden">
      <header class="bg-white dark:bg-slate-900 border-b border-slate-200 dark:border-slate-700 px-8 py-4 flex items-center justify-between">
        <h1 class="text-lg font-semibold text-slate-900 dark:text-slate-100">{{ activeItem.label }}</h1>
...
const emit = defineEmits<{ (e: 'logout'): void; (e: 'navigate'): void; (e: 'toggleDarkMode'): void }>()
